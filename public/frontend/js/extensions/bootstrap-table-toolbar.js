...
!function($) {
    ...
    var showAvdSearch = function(pColumns, searchTitle, searchText, that) {
        if (!$("#avdSearchModal" + "_" + that.options.idTable).hasClass("modal")) {
            ...
            $('#' + that.options.idForm).off('change', 'select').on('change', 'select', function (event) {
                clearTimeout(timeoutId);
                timeoutId = setTimeout(function () {
                    that.onColumnAdvancedSearch(event);
                }, that.options.searchTimeOut);
    ...
    var createFormAvd = function(pColumns, searchText, that) {
        ...
        for (var i in pColumns) {
            ...
            if (!vObjCol.checkbox && vObjCol.visible && vObjCol.searchable) {
                ...
                if (vObjCol.title == 'Activo') {
                		htmlForm.push(sprintf('<select class="form-control input-md" name="%s" id="%s">', vObjCol.field, vObjCol.field));
                		htmlForm.push('<option value="" selected>Seleccione una opci&oacute;n</option>');
                		htmlForm.push('<option value="glyphicon glyphicon-ok">Activo</option>');
                		htmlForm.push('<option value="actiona label label-danger">Inactivo</option>');
