...
<div class="row">
   <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
       ...
       <div class="alert alert-danger">
        ...
        {!!Form::open(array('url'=> 'companies/store', 'method' => 'POST', 'autocomplete' => 'off'))!!}
        {{Form::token()}}
        ...
        <div class="form-group">
        	...
        	<input type="text" name="Database" class="form-control" placeholder="Base de Datos...">
        </div>         
