...
@section('contentheader_title')
    <i class="fa fa-share-square"></i>  Listado de Compa&ntilde;&iacute;as
@endsection
           ...
           <table class="table table-striped table-bordered table-hover ui-datatable" id="dataList" style="width:100%">
             <thead>
              <tr > 
                ...
                <th style="float:true;vertical-align:middle">Base de Datos</th>
                <th style="float:true;vertical-align:middle">Acci&oacute;n</th>             
             </tr>          
             </thead>
             <tbody></tbody>
             @foreach ($companies as $comp)
               @include('backend.companies.modal')
             @endforeach 
           </table>
        </div>
   </div>
...
var url = "{{url('api/v1/accountant/companies') }}";
var editor;
